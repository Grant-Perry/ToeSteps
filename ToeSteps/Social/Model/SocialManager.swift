...
class SocialManager: ObservableObject {
   ...
   private func generateAchievementImage(_ achievement: Achievement) -> UIImage? {
	  ...
	  return renderer.image { context in
			// Background gradient
		 drawGradientBackground(color: UIColor(achievement.color), in: CGRect(origin: .zero, size: size), context: context.cgContext)
   ...
   private func generateGoalCompletionImage(_ goal: StepGoal, currentSteps: Int) -> UIImage? {
	  ...
	  return renderer.image { context in
			// Background
		 drawGradientBackground(color: UIColor(goal.type.color), in: CGRect(origin: .zero, size: size), context: context.cgContext)
   ...
   private func generateWeeklySummaryImage(_ insights: WeeklyInsights) -> UIImage? {
	  ...
	  return renderer.image { context in
			// Background
		 drawGradientBackground(color: UIColor.systemBlue, in: CGRect(origin: .zero, size: size), context: context.cgContext)
   ...
   private func drawGradientBackground(color: UIColor, in rect: CGRect, context: CGContext) {
